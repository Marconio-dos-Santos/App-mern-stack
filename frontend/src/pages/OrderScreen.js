...
export default function OrderScreen() {
  ...
  return loading ? (
    ...
    <div className='container'>
      <h3 className="my-3">Pedido {orderId}</h3>
      <Row>
        <Col md={8}>
          <Card className="mb-3">
            <Card.Body>
              ...
              <Card.Text>
                ...
                <strong>Eendereço: </strong> {order.shippingAddress.address},
                {order.shippingAddress.city}, {order.shippingAddress.postalCode}
                ,{order.shippingAddress.country}
              </Card.Text>
              {order.isDelivered ? (
                <MessageBox variant="success">
                  Entregue em {moment(order.deliveredAt).format("DD MM YYYY")}
                </MessageBox>
              ) : (
